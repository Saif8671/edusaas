...
const features = [
  {
    ...
    description: "Interactive dashboards, progress tracking, and personalized learning paths keep students motivated and engaged with their coursework.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Course Management",
    description: "Effortlessly create, organize, and deliver courses with built-in lesson planning, resource management, and assignment tracking.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Real-time Collaboration",
    description: "Live chat, discussion forums, video conferencing, and collaborative tools enable seamless communication between students and educators.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Assessment & Analytics",
    description: "Comprehensive grading tools, automated assessments, and detailed analytics help track student progress and identify learning gaps.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">Built for modern learning.</span>
          </h2>
        </div>
